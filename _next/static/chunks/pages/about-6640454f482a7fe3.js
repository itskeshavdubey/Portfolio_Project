            ...
            let r = (e) => {
                ...
                return "secondary" === t ?
                    (0, s.jsx)(i.E.button, {
                        ...
                        whileTap: { scale: 0.99 },
                        className: "m-1 px-3 py-2 rounded-xl flex items-center justify-center border border-gray-50 bg-gray-100 hover:bg-gray-200 hover:border-gray-100 active:border-gray-300 ".concat(
                            r
                        ),
                        children: n,
                    }) :
                    (0, s.jsx)(i.E.button, {
                        ...
                        whileTap: { scale: 0.99 },
                        className: "relative gradient-border m-1 px-3 py-2 rounded-xl flex items-center justify-center bg-black hover:bg-white hover:text-black opacity-95 hover:opacity-100 text-white ".concat(
                            r
                        ),
                        children: n,
                    });
                        ...
                        children: [
                            ...
                            (0, s.jsx)(o.E.div, {
                                ...
                                children: (0, s.jsx)(d.Z, {
                                    gradient: !1,
                                    speed: 100,
                                    className: "bg-gray-50 text-black p-2 rounded-full cursor-pointer border border-transparent hover:border hover:border-gray-200",
                                    ...
                                    (0, s.jsx)(m.M, {
                                        children: e &&
                                            (0, s.jsx)(o.E.nav, {
                                                ...
                                                exit: { opacity: 0, y: -12 },
                                                className: "z-10 absolute gradient-border w-48 top-14 right-0 bg-white rounded-lg shadow-lg p-2",
                                                children: (0, s.jsxs)("ul", {
                                                    children: [
                                                        (0, s.jsx)(a(), {
                                                            href: "/about",
                                                            children: (0, s.jsx)("li", {
                                                                className: "w-full cursor-pointer p-2 rounded-lg hover:bg-gray-50",
                                                                children: "About",
                                                            }),
                                                        }),
                                                        (0, s.jsx)(a(), {
        ...
        327: function(e, t, n) {
            ...
            let a = [{
                ...
                l = (e) => {
                    let { classes: t } = e;
                    return (0, s.jsx)("ul", {
                        className: "bg-gray-100 flex items-center justify-center p-1 rounded-3xl shadow-sm ".concat(
                            t
                        ),
                        children: a.map((e) => {
                            let { link: t, icon: n } = e;
                            return (0, s.jsx)(
                                r(), {
                                    ...
                                    children: (0, s.jsx)("img", {
                                        className: "h-6 opacity-50 transition-opacity duration-200 ease-in-out hover:opacity-100",
                                        src: n,
                                    }),
                                },
                                t
                    ...
                    children: [
                        ...
                        (0, s.jsxs)("div", {
                            ...
                            children: [
                                ...
                                (0, s.jsx)(r.Z, {
                                    classesMain: "hidden md:flex text-center text-xl md:text-4xl xl:text-6xl font-bold mt-20",
                                    classesSpan: "ml-1 md:ml-2 xl:ml-4",
                                    children: "Hey, hello and welcome stranger",
                                }),
                                (0, s.jsx)("p", {
                                    className: "mt-2 md:mt-5 w-4/5 md:w-2/3 text-sm md:text-lg xl:text-xl leading-6 md:leading-8 xl:leading-10 opacity-50",
                                    children: "I'm Keshav Dubey, a frontend web developer & UI/UX designer working remotely around the world. A 19-year-old student at Shiv Nadar University, currently in my second year of a B.tech in Computer Science and Engineering. I am based in Greater Noida and have a wide range of skills, including HTML, CSS, JavaScript, React JS, and Java as Technical Skills; UI/UX design (Figma), and Graphic Design (Adobe Photoshop) as my Design Skills. In addition to my skills, I am also a professional photographer. I have a strong foundation in computer science and engineering and am always looking for new ways to improve my skills and knowledge. I am a dedicated and hardworking individual with a passion for technology and design.",
                                }),
                                (0, s.jsxs)("div", {
                                    className: "mt-5 md:mt-10 flex items-center",
                                    children: [
                                        (0, s.jsx)(l.Z, {
                                            classes: "px-3 md:px-5 xl:px-8 py-2 md:py-3 xl:py-4 text-sm md:text-lg ml-10",
                                            children: "Schedule a call",
                                        }),
                                        (0, s.jsx)(a.Z, {
                                            onClick: () => e.push("/contact"),
                                            type: "secondary",
                                            classes: "px-3 md:px-5 xl:px-8 py-2 md:py-3 xl:py-4 text-sm md:text-lg ml-5 md:ml-10",
                                            children: "Contact Me",
                                        }),
                                    ],
                                }),
